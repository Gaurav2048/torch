...
const ColumnComponent: React.FC<OwnProps> = ({ column, tasks, openTask }) => {
  return (
    <Droppable droppableId={column.id}>
      {(provided) => (
        <Box width="300px" paddingBottom="40px" height="100%" overflowY="scroll" overflowX="hidden" ref={provided.innerRef} {...provided.droppableProps} sx={NOSCROLL_BAR_PROPERTIES}>
